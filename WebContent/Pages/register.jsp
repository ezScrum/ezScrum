...
<script type="text/javascript">
	$(function(){
		$("#dedd").on('click',function(){
			
			    window.open("https://github.com/login/oauth/authorize?client_id=4180e319672bde2d0e7e", "popupWindow", "width=600, height=400, scrollbars=yes");
		});
	    ...
	    if (queryParameters().code){
	        window.opener.$(window.opener.document).trigger('getCode', queryParameters().code);
	        window.close();
