...
public interface SprintBacklogUtil {
	public final static String TAG_SPRINTBACKLOG = "sprintBacklog"  ;
	public final static String TAG_STORYLIST = "storyList" ;
	public final static String TAG_STORY = "story" ;
	public final static String TAG_TASK = "task" ;
	public final static String TAG_TAGLIST =  "tagList" ;
	...
	public static final String TAG_HISTORYTYPE = "historyType";
