...
public class ReopenIssueAction extends PermissionAction {
	...
	public StringBuilder getResponse(ActionMapping mapping, ActionForm form,
		...
		SendNotification(sender, accToken, receiversId, id, issueType, project.getName());
		
		return result;
	}
	
	private void SendNotification(String sender, String accToken, ArrayList<Long> receiversId, long id, String issueType,String projectName){
