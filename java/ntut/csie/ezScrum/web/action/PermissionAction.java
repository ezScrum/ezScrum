...
public abstract class PermissionAction extends Action {
	...
	public abstract StringBuilder getResponse(ActionMapping mapping, ActionForm form,
...
//		if ( accountHelper.CheckAccount(request) && isValidAction() ) {
//			result = new StringBuilder(getResponse(mapping, form, request, response));
//			
//			if (isXML()) {
