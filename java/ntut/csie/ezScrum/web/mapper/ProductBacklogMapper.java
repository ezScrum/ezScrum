...
public class ProductBacklogMapper {
	...
	public void updateStoryRelation(String issueID,String releaseID , String sprintID,String estimation,String importance,Date date){
		IITSService itsService = m_itsFactory.getService(ITSEnum.MANTIS_SERVICE_ID,m_itsPrefs);
		itsService.openConnect();
		itsService.updateStoryRelationTable(issueID, m_project.getName(), releaseID, sprintID,estimation,importance,date);
		itsService.closeConnect();
	}
