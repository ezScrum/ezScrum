...
public class AppRuntimeException extends RuntimeException {
    private static final long serialVersionUID = -1192093044493945093L;
    ...
    public AppRuntimeException(Throwable aCause) {
        super(aCause);
    }

    public AppRuntimeException(String aMessage, Throwable aCause) {
