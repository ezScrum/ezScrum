...
-- 正在導出表  ezscrum_180.history 的資料：45 rows
...
REPLACE INTO `history` (`id`, `issue_id`, `issue_type`, `type`, `old_value`, `new_value`, `create_time`) VALUES
	...
	(24, 9, 3, 1, '', '', 1494298770244),
	(25, 10, 3, 1, '', '', 1494298781154),
	(26, 11, 3, 1, '', '', 1494298790584),
	(27, 11, 3, 2, 'Story03', 'Story4', 1494298808461),
	(28, 11, 3, 6, '10', '50', 1494298808461),
	(29, 11, 3, 7, '3', '5', 1494298808461),
	(30, 11, 3, 3, '6', '15', 1494298808461),
	(31, 11, 3, 2, 'Story4', 'Story03', 1494298837913),
	(32, 11, 3, 6, '50', '10', 1494298837913),
	(33, 11, 3, 7, '5', '3', 1494298837913),
	(34, 11, 3, 3, '15', '6', 1494298837913),
	(35, 12, 3, 1, '', '', 1494298847908),
	(36, 13, 3, 1, '', '', 1494298866150),
	(37, 14, 3, 1, '', '', 1494299035745),
	(38, 15, 3, 1, '', '', 1494299057056),
	(39, 14, 3, 16, '', '2', 1494299168112),
	(40, 11, 3, 16, '', '2', 1494299168116),
	(41, 10, 3, 16, '', '2', 1494299168119),
	(42, 9, 3, 16, '', '2', 1494299168123),
	(43, 15, 3, 16, '', '2', 1494299168126),
	(44, 12, 3, 16, '', '2', 1494299168130),
	(45, 13, 3, 16, '', '2', 1494299168134);
...
REPLACE INTO `project` (`id`, `name`, `display_name`, `comment`, `product_owner`, `attach_max_size`, `create_time`, `update_time`) VALUES
	...
	(2, 'Project02', 'Project02', 'Project02Comment', '', 2, 1494298681077, 1494298681077);
...
REPLACE INTO `scrum_role` (`id`, `access_productBacklog`, `access_sprintPlan`, `access_taskboard`, `access_sprintBacklog`, `access_releasePlan`, `access_retrospective`, `access_unplan`, `access_report`, `access_editProject`, `project_id`, `role`, `create_time`, `update_time`) VALUES
	...
	(6, 1, 1, 1, 1, 1, 1, 1, 1, 1, 2, 0, 1494298681078, 1494298681078),
	(7, 1, 1, 1, 1, 1, 1, 1, 1, 1, 2, 1, 1494298681078, 1494298681078),
	(8, 1, 1, 1, 1, 1, 1, 1, 1, 0, 2, 2, 1494298681079, 1494298681079),
	(9, 0, 0, 0, 0, 0, 0, 0, 1, 0, 2, 3, 1494298681079, 1494298681079),
	(10, 0, 0, 0, 0, 0, 0, 0, 0, 0, 2, 4, 1494298681080, 1494298681080);
...
REPLACE INTO `sprint` (`id`, `serial_id`, `goal`, `interval`, `team_size`, `available_hours`, `focus_factor`, `start_date`, `end_date`, `demo_date`, `demo_place`, `daily_info`, `project_id`, `create_time`, `update_time`) VALUES
	...
	(2, 1, 'Sprint01ForStory01', 1, 1, 24, 100, NOW(), NOW() + INTERVAL 6 DAY, NOW() + INTERVAL 6 DAY, '', '', 2, 1494299157565, 1494299157565);
...
-- 正在導出表  ezscrum_180.story 的資料：15 rows
...
REPLACE INTO `story` (`id`, `project_id`, `serial_id`, `sprint_id`, `name`, `status`, `estimate`, `importance`, `value`, `notes`, `how_to_demo`, `create_time`, `update_time`) VALUES
	...
	(9, 2, 1, 2, 'Story01', 1, 10, 13, 8, '', '', 1494298770244, 1494299168123),
	(10, 2, 2, 2, 'Story02', 1, 8, 12, 4, '', '', 1494298781154, 1494299168119),
	(11, 2, 3, 2, 'Story03', 1, 6, 10, 3, '', '', 1494298790584, 1494299168116),
	(12, 2, 4, 2, 'Story04', 1, 10, 50, 5, '', '', 1494298847908, 1494299168130),
	(13, 2, 5, 2, 'Story05', 1, 6, 60, 6, '', '', 1494298866150, 1494299168134),
	(14, 2, 6, 2, 'Story06', 1, 5, 5, 5, '', '', 1494299035745, 1494299168112),
	(15, 2, 7, 2, 'Story07', 1, 10, 15, 5, '', '', 1494299057056, 1494299168126);
...
-- 正在導出表  ezscrum_180.story_tag_relation 的資料：9 rows
...
-- 正在導出表  ezscrum_180.tag 的資料：11 rows
...
REPLACE INTO `tag` (`id`, `name`, `project_id`, `create_time`, `update_time`) VALUES
	...
	(6, 'Project02Tag01', 2, 1494298964067, 1494298964067),
	(7, 'Project02Tag02', 2, 1494298970754, 1494298970754),
	(8, 'ProjectsMutualTag01', 2, 1494298981352, 1494298981352),
	(9, 'Project02Tag03', 2, 1494298986134, 1494298986134),
	(10, 'ProjectsMutualTag02', 2, 1494299000015, 1494299000015),
	(11, 'ProjectsMutualTag03', 2, 1494299003076, 1494299003076);
