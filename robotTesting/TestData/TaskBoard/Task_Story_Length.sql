...
INSERT INTO `history` (`id`, `issue_id`, `issue_type`, `type`, `old_value`, `new_value`, `create_time`) VALUES
	...
	(6, 1, 1, 2, 'task 1 for test task Checked Out', 'task 1 for test task Done', 1467786075462),
	(7, 1, 1, 19, 'notes for test task Checked Out', 'notes for test task Done', 1467786075462);
...
INSERT INTO `story` (`id`, `project_id`, `serial_id`, `sprint_id`, `name`, `status`, `estimate`, `importance`, `value`, `notes`, `how_to_demo`, `create_time`, `update_time`) VALUES
	(1, 1, 1, 1, 'Story for taskboard AT story for taskboard text longer than testing engagement expectations environment', 1, 2, 3, 1, 'notes for show taskboard AT', 'demo display after show taskboard AT', 1467684301124, 1467684301124);
...
INSERT INTO `task` (`id`, `serial_id`, `project_id`, `story_id`, `name`, `handler_id`, `status`, `estimate`, `remain`, /*`actual`,*/ `notes`, `create_time`, `update_time`) VALUES
	(1, 1, 1, 1, 'task 1 for test task with longer words such as photosynthesis and environment Another word would be environment', -1, 1, 3, 3, /*0,*/ 'notes for test task Done', 1467785475696, 1467786075462);
