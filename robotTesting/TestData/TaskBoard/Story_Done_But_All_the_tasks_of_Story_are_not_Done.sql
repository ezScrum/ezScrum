...
INSERT INTO `history` (`id`, `issue_id`, `issue_type`, `type`, `old_value`, `new_value`, `create_time`) VALUES
	...
	(8, 1, 1, 2, 'task 1 for test task Done', 'task 1 for test task ReOpen', 1467786371069),
	(9, 1, 1, 19, 'notes for test task Done', 'notes for test task ReOpen', 1467786371069);
...
INSERT INTO `task` (`id`, `serial_id`, `project_id`, `story_id`, `name`, `handler_id`, `status`, `estimate`, `remain`, `actual`, `notes`, `create_time`, `update_time`) VALUES
	(1, 1, 1, 1, 'task 1 for test Story Done But All the tasks of Story are not Done', -1, 1, 3, 3, 0, 'notes for test Story Done But All the tasks of Story are not Done', 1467785475696, 1467786371069);
