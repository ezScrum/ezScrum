...
-- 正在導出表  ezscrum_180.history 的資料：41 rows
...
INSERT INTO `history` (`id`, `issue_id`, `issue_type`, `type`, `old_value`, `new_value`, `create_time`) VALUES
	...
	(25, 4, 3, 1, '', '', 1455507439322),
	(27, 6, 3, 1, '', '', 1455507485501),
	(28, 4, 3, 16, '', '6', 1455507557018),
	(29, 6, 3, 16, '', '6', 1455507557022),
	(30, 4, 1, 1, '', '', 1455507585583),
	(31, 4, 1, 16, '', '4', 1455507585599),
	(32, 4, 3, 17, '', '4', 1455507585602),
	(33, 5, 1, 1, '', '', 1455507599021),
	(34, 5, 1, 16, '', '6', 1455507599034),
	(35, 6, 3, 17, '', '5', 1455507599037),
	(36, 5, 1, 18, '', '6', 1455507610277),
	(37, 6, 3, 15, '', '5', 1455507610277),
	(38, 6, 1, 1, '', '', 1455507632414),
	(39, 6, 1, 16, '', '6', 1455507632426),
	(40, 6, 3, 17, '', '6', 1455507632429),
	(41, 4, 2, 1, '', '', 1455508470427),
	(43, 6, 2, 1, '', '', 1455508531473);
...
-- 正在導出表  ezscrum_180.story 的資料：5 rows
...
INSERT INTO `story` (`id`, `project_id`, `serial_id`, `sprint_id`, `name`, `status`, `estimate`, `importance`, `value`, `notes`, `how_to_demo`, `create_time`, `update_time`) VALUES
	...
	(4, 2, 1, 6, 'story1', 1, 0, 0, 10, '', '', 1455507439322, 1455507557018),
	(6, 2, 3, 6, 'story3', 1, 0, 0, 10, '', '', 1455507485501, 1455507557022);
...
INSERT INTO `task` (`id`, `serial_id`, `project_id`, `story_id`, `name`, `handler_id`, `status`, `estimate`, `remain`, `actual`, `notes`, `create_time`, `update_time`) VALUES
	...
	(4, 1, 2, 4, 'task1', -1, 1, 10, 10, 0, 'note', 1455507585583, 1455507585583),
	(5, 2, 2, -1, 'task2', -1, 1, 10, 10, 0, 'note', 1455507599021, 1455507610277),
	(6, 3, 2, 6, 'task3', -1, 1, 10, 10, 0, 'note', 1455507632414, 1455507632414);
...
-- 正在導出表  ezscrum_180.unplan 的資料：5 rows
...
INSERT INTO `unplan` (`id`, `serial_id`, `name`, `handler_id`, `estimate`, `actual`, `notes`, `status`, `project_id`, `sprint_id`, `create_time`, `update_time`) VALUES
	...
	(4, 1, 'unplanned1', -1, 0, 0, '', 1, 2, 6, 1455508470427, 1455508470427),
	(6, 3, 'unplanned3', -1, 0, 0, '', 1, 2, 6, 1455508531473, 1455508531473);
