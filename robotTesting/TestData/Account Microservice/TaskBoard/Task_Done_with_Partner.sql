...
-- 正在導出表  account_ms.user 的資料：~3 rows (大約)
DELETE FROM `user`;
...
INSERT INTO `user` (`id`, `email`, `enabled`, `password`, `systemrole`, `username`, `nickname`) VALUES
	...
	(2, 'Acount01@gmail.com', b'1', '$2a$10$0p1gagkGwVNVgIEpL1CPP.dZQDxoYNEhSG9ThK5AwxViDuMDnYUYm', b'0', 'Acount01', 'Acount01'),
	(3, 'Acount02@gmail.com', b'1', '$2a$10$TPBFEnDkf0/XcgMwnNZHIel6z7Hs1XZpV9Bt7dABiEwh5EEWsdh/y', b'0', 'Acount02', 'Acount02');
