...
INSERT INTO `user` (`id`, `email`, `enabled`, `password`, `systemrole`, `username`, `nickname`) VALUES
	...
	(2, 'account1@mail.com', b'1', '$2a$10$kq1P8RllTx8EmbuSq7.1Vu3SZWRs/h2V/vJZKLnFmUIESkFG3Ynhy', b'0', 'account1', 'account1'),
	(3, 'account2@mail.com', b'1', '$2a$10$7IP/IVvXEOGx6pWrFZLkgebXCac0SxEk2fja.ZUtX7E8XzoD.ADfe', b'0', 'account2', 'account2');
