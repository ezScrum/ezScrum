...
-- 正在導出表  account_ms.user 的資料：~2 rows (大約)
DELETE FROM `user`;
...
INSERT INTO `user` (`id`, `email`, `enabled`, `password`, `systemrole`, `username`, `nickname`) VALUES
	...
	(2, 'TestAccountIDEdited@scrum.tw', b'1', '$2a$10$VzVhpSv0wZD5zZaYxl2/N.QOHqbeRSZ0C7Tz7smpQL7ILBWEUjdC.', b'0', 'TestAccountID', 'TestAccountIDNameEdited');
