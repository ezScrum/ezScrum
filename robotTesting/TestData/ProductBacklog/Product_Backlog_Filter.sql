...
INSERT INTO `history` (`id`, `issue_id`, `issue_type`, `type`, `old_value`, `new_value`, `create_time`) VALUES
	(1, 1, 3, 1, '', '', 1466561593751),
	(2, 2, 3, 1, '', '', 1466561625193),
	(3, 3, 3, 1, '', '', 1466561651754),
	(4, 4, 3, 1, '', '', 1466561680324);
...
INSERT INTO `story` (`id`, `project_id`, `serial_id`, `sprint_id`, `name`, `status`, `estimate`, `importance`, `value`, `notes`, `how_to_demo`, `create_time`, `update_time`) VALUES
	(1, 1, 1, -1, 'newStoryNormal', 1, 0, 0, 0, '"Note: newStoryNormal"', '"HowToDemo: newStoryNormal"', 1466561593751, 1466561593751),
	(2, 1, 2, -1, 'newStoryBacklogged', 1, 0, 0, 0, '"Note: newStoryBacklogged"', '"HowToDemo: newStoryBacklogged"', 1466561625193, 1466561625193),
	(3, 1, 3, -1, 'newStoryDetailed', 1, 5, 5, 5, '"Note: newStoryDetailed"', '"HowToDemo: newStoryDetailed"', 1466561651754, 1466561651754),
	(4, 1, 4, -1, 'newStoryDone', 1, 8, 8, 8, '"Note: newStoryDone"', '"HowToDemo: newStoryDone"', 1466561680324, 1466561680324);
