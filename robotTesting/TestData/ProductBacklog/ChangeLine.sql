...
-- 正在導出表  ezscrum_180.account 的資料：0 rows
DELETE FROM `account`;
...
INSERT INTO `history` (`id`, `issue_id`, `issue_type`, `type`, `old_value`, `new_value`, `create_time`) VALUES
	(1, 1, 3, 1, '', '', 1466474696042),
	(2, 1, 3, 19, 'Note: newStory', 'Note: newStory\nChangeLine', 1475664605231),
	(3, 1, 3, 20, 'HowToDemo: newStory', 'HowToDemo: newStory\nChangeLine', 1475664605231);
...
INSERT INTO `story` (`id`, `project_id`, `serial_id`, `sprint_id`, `name`, `status`, `estimate`, `importance`, `value`, `notes`, `how_to_demo`, `create_time`, `update_time`) VALUES
	(1, 1, 1, -1, 'oriStory', 1, 3, 1, 5, 'Note: newStory\nChangeLine', 'HowToDemo: newStory\nChangeLine', 1466474696042, 1475664605231);
...
-- 正在導出表  ezscrum_180.system 的資料：0 rows
DELETE FROM `system`;
...
INSERT INTO `tag` (`id`, `name`, `project_id`, `create_time`, `update_time`) VALUES
	(1, 'testTagName', 1, 1466474643600, 1466474643600);
