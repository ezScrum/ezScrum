...
-- 正在導出表  ezscrum_180.story 的資料：4 rows
DELETE FROM `story`;
...
INSERT INTO `story` (`id`, `project_id`, `serial_id`, `sprint_id`, `name`, `status`, `estimate`, `importance`, `value`, `notes`, `how_to_demo`, `create_time`, `update_time`) VALUES
	(1, 1, 1, -1, 'newStory', 1, 3, 1, 5, '"Note: newStoryNote"', '"HowToDemo: newStoryHowToDemo"', 1466564245598, 1466564245598);
