...
public class StoryObjectTest {
	...
	public void testGetTasks() {
		...
		task1.setName("TASK_NAME_1").setNotes("TASK_NOTE_1").setEstimate(2).setStoryId(story.getId());
		task1.save();
		
		TaskObject task2 = new TaskObject(mProjectId);
		task2.setName("TASK_NAME_2").setNotes("TASK_NOTE_2").setEstimate(3).setStoryId(story.getId());
		task2.save();
